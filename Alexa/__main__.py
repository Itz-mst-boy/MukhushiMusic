...
async def initiate_bot():
    ...
    try:
        await app.send_message(
            LOG_GROUP_ID,
            "<b>ᴄᴏɴɢʀᴀᴛs ᴍᴜᴋʜᴜsʜɪ ᴍᴜsɪᴄ ʙᴏᴛ ʜᴀs sᴛᴀʀᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʟʏ 🌸✨</b>",
        )
    except Exception as e:
        print(
    ...
    if STRING1 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_1.join_chat("worldwide_friend_zone")
            await ASS_CLI_1.join_chat("mukhushi_official")
        except:
            pass
...
async def help_parser(name, keyboard=None):
    ...
    return (
        """**ʜᴇʟʟᴏ {first_name},
ɪ ᴀᴍ ᴀ ᴍᴜsɪᴄ ʙᴏᴛ, ɪ ᴄᴀɴ ᴘʟᴀʏ ᴍᴜsɪᴄ ɪɴ ʏᴏᴜʀ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴs ғᴏʀ ᴍᴏʀᴇ ɪɴғᴏʀᴍᴀᴛɪᴏɴ ᴍᴀᴅᴇ ʙʏ** @iTz_mSt_bOy
